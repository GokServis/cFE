/************************************************************************
 * Mission override: cFE Table Services (CFE_TBL) platform config.
 *
 * This file shadows the module default `default_cfe_tbl_platform_cfg.h` and
 * is selected by the sample mission build via `cfs/sample_defs/`.
 *
 * We keep the upstream defaults but increase the maximum table sizes so
 * `AI_APP.WEIGHTS` (~105 KB) can register in the lab.
 ************************************************************************/
...
#define DEFAULT_CFE_PLATFORM_TBL_BUF_MEMORY_BYTES 1048576
...
#define DEFAULT_CFE_PLATFORM_TBL_MAX_DBL_TABLE_SIZE 131072
...
#define DEFAULT_CFE_PLATFORM_TBL_MAX_SNGL_TABLE_SIZE 131072
